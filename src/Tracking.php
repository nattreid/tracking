...
use NAttreid\Security\User,
    ...
    NAttreid\Tracking\Model\TrackingPages,
    NAttreid\Tracking\Model\TrackingVisits,
    NAttreid\Tracking\Model\ClickTrackingGroup,
    NAttreid\Tracking\Model\ClickTracking,
